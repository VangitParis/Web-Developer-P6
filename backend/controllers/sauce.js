...
exports.like = (req, res, next) => {
  ...
  /*requête envoyée sous format JSON contenant les propriétés userId et like dans Postman ou depuis le PORT
  {
...
*/
  ...
  // L' userId doit être égal à un userId existant dans la bdd sinon voir else ( utilisateur inconnu)
      ...
      .then((sauce) => {
        ...
        switch (req.body.like) {
          ...
          case 1:
            ...
            // et si like === 1
            if (!sauce.usersLiked.includes(req.body.userId) && (req.body.like === 1) && (!sauce.usersDisliked.includes(req.body.userId))) {

              console.log("userId n'est pas dans le tableau usersLiked ET n'est pas dans le tableau usersDisliked ET likes = 1");
              ...
              Sauce.updateOne(
                ...
                .catch(error => { console.log('Utilisateur Inconnu'); res.status(401).json({ error }) });
            } else { res.status(401).json({ error: "L'Utilisateur a déjà voté !" }) };
